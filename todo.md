...
- [x] 创建文献对话界面组件
- [x] 支持摘要提取和核心观点总结
- [x] 编写文献处理功能的单元测试（18个测试通过）
- [ ] 支持将对话结果引用到编辑器

## 图表与数据可视化生成
- [ ] 暴露chartGenerator.ts能力到前端
- [ ] 创建数据表格输入界面
- [ ] 实现AI自动生成图表功能
- [ ] 支持折线图、柱状图、流程图生成
- [ ] 支持图表插入到论文编辑器
...
## 图表生成功能完善（第二阶段）
- [x] 检查chartGenerator.ts现有功能
- [x] 检查ChartTools.tsx页面实现
- [x] 优化图表生成界面（CSV上传、文字描述输入）
- [x] 添加图表预览和编辑功能
- [x] 支持图表导出为PNG格式（高清2倍分辨率）
- [x] 添加图表列表管理功能
- [x] 支持删除图表
- [ ] SVG导出功能（待实现）
- [ ] 在论文编辑器中集成图表插入功能
...
## LaTeX导出功能（第二阶段）
- [x] 检查latexExporter.ts现有实现
- [x] 完善LaTeX模板支持（IEEE、Nature、Elsevier、Springer、通用）
- [x] 实现论文内容到LaTeX格式转换
- [x] 支持数学公式LaTeX格式化
- [x] 支持表格LaTeX代码生成
- [x] 生成LaTeX源码文件（.tex）
- [x] 在论文编辑器中添加LaTeX导出按钮
- [x] 添加模板选择对话框
- [x] 上传到S3并提供下载链接
- [x] 编写LaTeX导出功能的单元测试（15个测试通过）

## 界面美化升级（第二阶段）
- [ ] 统一替换shadcn/ui组件为Fluent UI组件
- [ ] 优化首页设计（Fluent Design风格）
- [ ] 优化论文列表页面
- [ ] 优化论文编辑器界面
- [ ] 添加编辑器专注模式（Zen Mode）
- [ ] 优化中文字体排版（Noto Sans SC，行高1.6-1.8）
- [ ] 升级仪表盘视觉效果（动画图表、骨架屏）
- [ ] 添加页面切换动画
- [ ] 优化空状态设计
- [ ] 测试深色/浅色模式一致性
...
## Bug修复
- [x] 修复Vite WebSocket连接警告（配置HMR使用wss协议和443端口）
